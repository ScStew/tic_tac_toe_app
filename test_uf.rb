...
class Test_unbeatable < Minitest::Test
    ...
    def test_fourth_action_1_9
        board = {"1"=> "o","2" => "2","3"=> "3", "4"=> "4", "5" => "x" ,"6" => "6", "7" => "7","8" => "8", "9" => "o"}
        player = 'x'
        assert_equal("2",fourth_action(board,player))
    end


    def test_fourth_action_5_3
        board = {"1"=> "1","2" => "2","3"=> "x", "4"=> "4", "5" => "x" ,"6" => "6", "7" => "o","8" => "8", "9" => "9"}
        player = 'o'
        assert_equal('1',fourth_action(board,player))
    end
    
    def test_third_action_return_3
        board = {"1"=> "1","2" => "2","3"=> "x", "4"=> "4", "5" => "o" ,"6" => "6", "7" => "x","8" => "8", "9" => "9"}
        player = 'x'
    ...
    def test_fith_action_return_9
        board = {"1"=> "1","2" => "2","3"=> "o", "4"=> "o", "5" => "x" ,"6" => "6", "7" => "x","8" => "8", "9" => "9"}
        player = "x"
        assert_equal("9",fifth_action(board,player))
    end

    def test_fifth_action_return_1
        board = {"1"=> "1","2" => "2","3"=> "o", "4"=> "4", "5" => "x" ,"6" => "6", "7" => "x","8" => "o", "9" => "9"}
        player = 'x'
        assert_equal("1",fifth_action(board,player))
    end

    # def test_fourth_action_1_6
    #     board = {"1"=> "x","2" => "2","3"=> "3", "4"=> "4", "5" => "o" ,"6" => "x", "7" => "7","8" => "8", "9" => "9"}
    #     player = "o"
